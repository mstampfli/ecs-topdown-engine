...
Shader::Shader(const char* vertexShaderPath, const char* fragmentShaderPath){
    ...
    setUniform(useTextureUniform, false);
}
...
void Shader::setTexture(int slot){
    textureUniform = getUniform("tex");
    useTextureUniform = getUniform("useTexture");
    setUniform(textureUniform, slot);
    setUniform(useTextureUniform, true);
}
